...
const Button: FC<props> =({theme, icon, children, ...rest})=> {
  ...
  return (
    <button {...rest} className={"inline-flex justify-center items-center px-4 py-2 text-sm font-medium  border shadow-sm  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 " + themeClasses + ' ' + radiusClass}>
